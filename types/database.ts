  ...
  public: {
    Tables: {
      analyses: {
        Row: {
          ...
          id: string
          overall_virality_score: number | null
          platforms: string[]
          status: string | null
          title: string
          user_id: string
      ...
      platform_insights: {
        ...
        Relationships: [
          {
            foreignKeyName: "platform_insights_analysis_id_fkey"
            columns: ["analysis_id"]
            isOneToOne: false
      ...
      user_preferences: {
        Row: {
          created_at: string | null
          default_audience_demographics: Json | null
          id: string
    ...
    Functions: {
      decrement_user_credits: {
        Args: { user_uuid: string; credit_cost?: number }
        Returns: boolean
      }
